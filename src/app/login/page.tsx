...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-[#06080b]/70 via-[#06080b]/55 to-[#06080b]" />
      <div
        className="absolute -top-24 start-[-120px] h-[420px] w-[420px] rounded-full opacity-25 blur-3xl"
        style={{ background: "radial-gradient(circle,#2de6b8,transparent 65%)", animation: "floaty 9s ease-in-out infinite" }}
      />
      <div
        className="absolute bottom-[-140px] end-[-100px] h-[480px] w-[480px] rounded-full opacity-20 blur-3xl"
        style={{ background: "radial-gradient(circle,#8b7cff,transparent 65%)", animation: "floaty 11s ease-in-out infinite reverse" }}
      />
        ...
        <div className="hidden flex-col justify-between p-12 lg:flex">
          <div className="anim-in flex items-center gap-3">
            <div
              ...
              style={{
                background: "linear-gradient(135deg,#37f2c4 0%,#19b3ff 55%,#8b7cff 100%)",
                boxShadow: "0 14px 34px -10px rgba(45,230,184,.6)",
              }}
            >
              <Droplets size={24} className="text-[#04150f]" strokeWidth={2.7} />
            </div>
            <div className="leading-tight">
              <div className="text-2xl font-black tracking-tight">سُحُب</div>
          ...
          <div>
            <h1 className="anim-in anim-d1 max-w-[520px] text-[44px] font-black leading-[1.25] tracking-tight">
              ...
              <span
                ...
                style={{ backgroundImage: "linear-gradient(90deg,#37f2c4,#19b3ff,#8b7cff)" }}
              >
                تحت السيطرة الكاملة
              </span>
            </h1>
            <p className="anim-in anim-d2 mt-5 max-w-[440px] text-[15px] font-semibold leading-8 text-[var(--muted)]">
              نظام متكامل لإدارة منتجات الليكويد والسجائر الإلكترونية: أصناف
            ...
            <div className="anim-in anim-d3 mt-8 flex flex-wrap gap-2.5">
              {[
                ...
                <span
                  ...
                  style={{ background: "rgba(10,14,18,.55)", backdropFilter: "blur(8px)" }}
                >
          ...
          <div className="anim-in anim-d4 text-[11.5px] font-bold text-[var(--faint)]">
            نظام سُحُب v1.0 — إدارة ذكية لنشاطك التجاري
          </div>
        </div>
          ...
          >
            <div className="mb-7 flex items-center gap-3 lg:hidden">
              <div
                ...
                style={{ background: "linear-gradient(135deg,#37f2c4,#8b7cff)" }}
              >
                <Droplets size={22} className="text-[#04150f]" strokeWidth={2.7} />
              </div>
              <div className="text-xl font-black">سُحُب</div>
            </div>
