...
/** يمنع وميض اللغة/الاتجاه الخاطئ قبل أول رسم. */
const LANG_BOOT = `(function(){try{var l=localStorage.getItem("cc-lang");if(l==="en"){var d=document.documentElement;d.setAttribute("lang","en");d.setAttribute("dir","ltr");}}catch(e){}})();`;
