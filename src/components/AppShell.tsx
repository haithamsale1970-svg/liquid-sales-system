...
function pageTitle(pathname: string): string {
  ...
  return NAV.find((n) => n.href === m)?.label ?? "سُحُب";
}
    ...
    <ToastProvider>
      <div className="flex min-h-screen">
        ...
        <aside
          data-sidebar
          className={cls(
            "flex w-[252px] shrink-0 flex-col gap-1.5 border-e border-[var(--line-soft)] bg-[#080b0f]/90 p-4 backdrop-blur-xl lg:sticky lg:top-0 lg:h-screen",
            open && "open",
          )}
        >
            ...
            <Link href="/" className="flex items-center gap-3 px-1 py-2">
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 10px 26px -8px rgba(45,230,184,.5)",
                }}
              >
                <Droplets size={20} className="text-[#04150f]" strokeWidth={2.7} />
              </div>
              <div className="leading-tight">
                <div className="text-[18px] font-black tracking-tight">سُحُب</div>
                <div className="text-[10.5px] font-bold text-[var(--faint)]">
                  إدارة الليكويد والمبيعات
                </div>
              </div>
            </Link>
            <button
          ...
          <div className="mt-2 rounded-2xl border border-[var(--line-soft)] bg-[rgba(255,255,255,.03)] p-3.5">
            <div className="flex items-center gap-3">
              <div
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl text-[12px] font-extrabold text-[#052018]"
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header
            data-chrome
            className="sticky top-0 z-40 flex items-center justify-between gap-3 border-b border-[var(--line-soft)] bg-[#06080b]/80 px-4 py-3 backdrop-blur-xl sm:px-6"
          >
